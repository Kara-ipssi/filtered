import { InputLabel, TextField, FormControl, Select, MenuItem, SelectChangeEvent} from '@mui/material';
        ...
        >
            ...
            <FormControl sx={{ m: 1, minWidth: 120 }}>
                ...
                <Select
                    ...
                    >
                        <MenuItem value="" selected disabled>None</MenuItem>
                        {
                ...
                >
                    <MenuItem value="" selected disabled>None</MenuItem>
                    {
                        operatorList && operatorList.map((operator)=>{
                            return <MenuItem value={operator.value}>{operator.fullName}</MenuItem>
                        })
                    }
                </Select>
            </FormControl>
